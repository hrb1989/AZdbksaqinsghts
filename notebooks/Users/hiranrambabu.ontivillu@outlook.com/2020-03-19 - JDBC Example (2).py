...
url = "jdbc:sqlserver://azdbksd7sr1.database.windows.net:1433;database=azdbksd7sql1"
table = "dbo.azdbksd7tab1"
user = "azdbksd7sa@azdbksd7sr1"
password = "AZdbksd7"
...
display(remote_table.select("c1"))
...
# MAGIC %sql
# MAGIC insert into testing values (1,1,1)
...
# MAGIC %sql
# MAGIC insert into jdbctest values (1,1,1);
# MAGIC insert into jdbctest values (1,2,3);
# MAGIC insert into jdbctest values (2,1,2);
