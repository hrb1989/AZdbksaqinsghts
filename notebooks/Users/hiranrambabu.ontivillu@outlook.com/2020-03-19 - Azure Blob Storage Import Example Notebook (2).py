...
#wasbs://<container Name>@<storage account name>.<stg type - blob>.core.windows.net/<blob path>
#https://azdbksd7stg1.blob.core.windows.net/azdbksd7cont1/weekly-rent-paid-by-household-2018-census-csv.csv
#DefaultEndpointsProtocol=https;AccountName=azdbksd7stg1;AccountKey=+D6GeGvd01IT559ngKZbmGzFWwXtRmXE+TyiAlwYtQ+whtGtMWrRF4VJpcDHooRx9LFCtshe6wbD+HoYzoGM5A==;EndpointSuffix=core.windows.net
...
temp_table_name = "blobcsvtemp"


df=df.withColumnRenamed("Weekly rent paid by household","week")
...
df.write.format("parquet").saveAsTable("blobcsv")
